...
export default {
  ...
  'datastudio.catalog.delete.table': '删除 [{catalog}.{database}.{table}]',
  ...
  'sys.setting.oauth': 'OAuth 配置',
  'sys.setting.oauth.tooltip': 'Keycloak 与 Dinky 用户 Confidential Client 同步',
  'sys.oauth.settings.sync': '手动同步',
  'sys.oauth.settings.sync.success': 'Success: 用户同步完成',
